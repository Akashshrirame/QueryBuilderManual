...
export default class SoqlQueryBuilder extends LightningElement {
    ...
    @api
    get queryString() {
        console.log("Query String is " + this._queryString);
    ...
    buildQuery() {
        if (this._objectType && this._selectedFields && this._selectedFields.length) {
            ...
            console.log("Builded query is " + this._queryString);
            this.dispatchSoqlChangeEvent();
        }
    }
    ...
    handleSearch(event) {
        ...
        this.template
          .querySelector('c-displayDataTable')
    ...
    showDataTable() {
        console.log("Button Click " + this._queryString);
        this.showTable = true;
    }
